...
/**
 * Ensures the notification tables exist for fresh installations and hosts
 * where the CLI migration command has not run yet. Normal deployments should
 * still apply database/migrations/2026_08_03_notification_center.sql.
 */
