...
<channel>
  <wp:base_site_url>https://legacy.example.uz</wp:base_site_url>
  <item>
    <title>Attachment</title>
    <wp:post_id>4073</wp:post_id>
    <wp:post_type>attachment</wp:post_type>
    <wp:attachment_url>https://legacy.example.uz/wp-content/uploads/2026/07/1-scaled.jpg</wp:attachment_url>
  </item>
  <item>
    <title>Тестовая новость</title>
    <link>https://legacy.example.uz/test-novost/</link>
    <content:encoded><![CDATA[<p>Тело <img src="https://legacy.example.uz/wp-content/uploads/2026/07/2.jpg"></p>]]></content:encoded>
...
XML;
    ...
    assert_same('https://legacy.example.uz', $d['site'], 'база сайта разобрана');
    ...
    assert_same('https://legacy.example.uz/wp-content/uploads/2026/07/1-scaled.jpg', $d['attachments'][4073] ?? '', 'вложение по id');
